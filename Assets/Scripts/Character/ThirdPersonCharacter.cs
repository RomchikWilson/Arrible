...
namespace UnityStandardAssets.Characters.ThirdPerson
{
	...
	public class ThirdPersonCharacter : MonoBehaviour
	{
		...
		[SerializeField] private float m_ObjectCheckDistance = 0.5f;
		...
		private GameObject trigger = default;
        ...
        private void Update()
        {
			if (trigger && Input.GetKeyDown("e"))
			{
				switch (trigger.tag)
				{
					case "Button":

						var scr = trigger.GetComponent<ButtonController>();
						scr.ActivateDeactivateObject();
						break;
        ...
        void OnTriggerEnter(Collider collision)
		{
			switch (collision.gameObject.tag)
			{
				case "Button":
					...
					UIController.ActivateDeactivatePanelMessage?.Invoke(true);
		...
		void OnTriggerExit(Collider collision)
		{
			switch (collision.gameObject.tag)
			{
				case "Button":
					...
					trigger = default;
					UIController.ActivateDeactivatePanelMessage?.Invoke(false);
		...
		public void OnAnimatorMove()
		{
			...
			if (m_IsGrounded && Time.deltaTime > 0 && gameStorageSO.Play)
			{
